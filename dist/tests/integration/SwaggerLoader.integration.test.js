...
describe('SwaggerLoader Integration Tests', () => {
    ...
    beforeEach(() => {
        ...
        swaggerLoader = new SwaggerLoader('https://api.portaldatransparencia.gov.br/v3/api-docs', logger);
    });
    describe('Real Portal da Transparência API', () => {
        it('should load the actual Portal da Transparência Swagger spec', async () => {
            ...
            const hasCommonEndpoints = pathsString.includes('viagens') ||
        ...
        it('should detect spec changes when comparing different URLs', async () => {
            ...
            const hasChanges = await swaggerLoader.detectSpecChanges('https://petstore.swagger.io/v2/swagger.json');
    ...
    describe('Error handling with invalid URLs', () => {
        it('should handle invalid URL gracefully', async () => {
            const invalidLoader = new SwaggerLoader('https://invalid-url-that-does-not-exist.com/swagger.json', logger);
...
//# sourceMappingURL=SwaggerLoader.integration.test.js.map