...
export class SwaggerLoader {
    constructor(specUrl = 'https://api.portaldatransparencia.gov.br/v3/api-docs', logger, authHeaders) {
    ...
    async loadSpec() {
        try {
            ...
            // Validate the spec
            const validatedSpec = (await SwaggerParser.validate(rawSpec));
    ...
    async detectSpecChanges(newSpecUrl) {
